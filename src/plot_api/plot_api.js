...
function _relayout(gd, aobj) {
    ...
    for(var ai in aobj) {
        ...
        if(pleaf === 'type') {
            ...
            var toSignlog = parentFull.type === 'linear' && vi === 'signlog';
            var fromSignlog = parentFull.type === 'signlog' && vi === 'linear';
            
            if(toLog || fromLog || toSignlog || fromSignlog) {
                if(!ax || !ax.range) {
